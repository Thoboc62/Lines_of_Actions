...
class Engine extends OpenXum.Engine {
    ...
    _next_same_found(piece) {
        if (this._next_to_left(piece) === true || this._next_to_right(piece) === true ||
            this._next_to_top(piece) === true || this._next_to_down(piece) === true ||
            this._next_to_down_left(piece) === true || this._next_to_down_right(piece) === true
            || this._next_to_top_left(piece) === true || this._next_to_top_right(piece) === true) {
            return true;
        }
    ...
    _next_same_found_bis(piece) {
        if (this._next_to_right(piece) === true || this._next_to_top_right(piece) === true || this._next_to_down_right(piece) === true) {
            return true;
        }
        return false;
    ...
    _next_same_found_bis_s(piece) {
        if (this._next_to_left(piece) === true || this._next_to_down_left(piece) === true
            || this._next_to_top_left(piece) === true) {
            return true;
        }
        return false;
    ...
    */
    ...
    _check_winner() {
        ...
        let a = this._count_nb_pieces_black();
        let b = this._count_nb_pieces_white();

        let cptB = a;//compteur noir
        let cptW = b;//compteur blanc
        //let nb1=0;//compteur premier noir
        //let nb2=0;//compteur premier blanc
        //console.log(cptB);
        //console.log(cptW);
        ...
        if (a > 1 && b > 1) {
            for (let i = 0; i < 8; i++) {
                for (let j = 0; j < 8; j++) {
                    let piece_c = this._board[i][j];

                    if (piece_c !== undefined && piece_c.color() === Color.BLACK && this._next_same_found(piece_c) === true && this._next_same_found_bis(piece_c) === true) {
                        cptB = cptB - 1;
                        //console.log("voisin Noir trouver");
                        //console.log(cptB);
                        if (cptB === 0) {
                    ...
                    else if (piece_c !== undefined && piece_c.color() === Color.BLACK && this._next_same_found_bis(piece_c) === false && this._next_same_found_bis_s(piece_c) === true) {
                        cptB = cptB - 1;
                        //console.log("voisin Noir trouver");
                        //console.log(cptB);
                        if (cptB === 0) {
                    ...
                    else if (piece_c !== undefined && piece_c.color() === Color.BLACK && this._next_same_found(piece_c) === false && this._next_same_found_bis(piece_c) === false) {
                        //console.log("pas de voisin noir");
                        cptB = a;

                    }


                    else if (piece_c !== undefined && piece_c.color() === Color.WHITE && this._next_same_found(piece_c) === true && this._next_same_found_bis(piece_c) === true) {
                        cptW = cptW - 1;
                        //console.log("voisin Blanc trouver");
                        //console.log(cptW);
                        if (cptW === 0) {
                    ...
                    else if (piece_c !== undefined && piece_c.color() === Color.WHITE && this._next_same_found_bis(piece_c) === false && this._next_same_found_bis_s(piece_c) === true) {
                        cptW = cptW - 1;
                        //console.log("voisin Blanc trouver");
                        //console.log(cptW);
                        if (cptW === 0) {
                    ...
                    else if (piece_c !== undefined && piece_c.color() === Color.WHITE && this._next_same_found(piece_c) === false && this._next_same_found_bis(piece_c) === false) {
                        //console.log("pas de voisin blanc");
                        cptW = b;
